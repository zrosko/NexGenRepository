...
import com.rbc.nexgen.batch.service.IIPMJobService;

/**
 * http://localhost:8082/api/job/start/IIPM Job
 * @author zrosk
 */
@RestController
@RequestMapping("/api/job")
public class IIPMJobController {
	
	@Autowired
	IIPMJobService jobService;
	...
	public String startJob(@PathVariable String jobName, 
		...
		jobService.startIIPMJob(jobName, jobParamsRequestList);
		return "Job Started...";
	}
