...
public class DatabaseConfig {
	...
	public EntityManagerFactory postgresqlEntityManagerFactory() {
		...
		lem.setPackagesToScan("com.rbc.nexgen.batch.postgresql.entity");
	...
	public EntityManagerFactory mysqlEntityManagerFactory() {
		...
		lem.setPackagesToScan("com.rbc.nexgen.batch.mysql.entity");
		lem.setJpaVendorAdapter(new HibernateJpaVendorAdapter());
		lem.setPersistenceProviderClass(HibernatePersistenceProvider.class);
		lem.afterPropertiesSet();
	...
	public JpaTransactionManager jpaTransactionManager() {
		...
		//Here replace or create new transactioManager
		jpaTransactionManager.setEntityManagerFactory(sqlserverEntityManagerFactory());
