...
public void restCallToGetApplications() {
	...
	try {
	open(new FileSystemResource("C:\\Users\\zrosk\\git\\NexGenRepository\\NexGenBatchTemplate\\InputFiles\\applications.json"));
	list = new ArrayList<>();
...
public Object getObjectFromTheList(/*long id, String name*/) {
	log.info("We are reading 1 by 1 here ");
...
public static void main(String[] args) {
	...
	IIPMApplication dataset = (IIPMApplication) reader.read();
	System.out.println("FIRST="+dataset);
	Object dataset1 = reader.read();
