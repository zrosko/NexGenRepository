package com.rbc.nexgen.iipm.security;
...
public class AuthenticationFilter {//extends UsernamePasswordAuthenticationFilter {
	...
	/*
	 * private UsersService usersService; private Environment environment;
	 * 
	 * public AuthenticationFilter(UsersService usersService, Environment
	 * environment, AuthenticationManager authenticationManager) { this.usersService
	 * = usersService; this.environment = environment;
	 ...
	 * IOException, ServletException { String userName = ((User)
	 * auth.getPrincipal()).getUsername(); UserDto userDetails =
	 * usersService.getUserDetailsByEmail(userName);
	 * 
	 ...
	 * .compact();
	 * 
	 * res.addHeader("token", token); res.addHeader("userId",
